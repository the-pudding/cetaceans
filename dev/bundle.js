...
var controller = new _scrollmagic2.default.Controller({ refreshInterval: 0 });
...
var containerSel = bodySel.select('.section--scroll');
var graphicSel = containerSel.select('.scroll__graphic');
...
function setupStep() {
	...
	scene.on('enter', function (event) {
		var step = selection.attr('data-step');
		var down = event.scrollDirection === 'FORWARD';
...
function setupEnterExit() {
	...
	enterExitScene = new _scrollmagic2.default.Scene({
	...
	enterExitScene.on('enter', function (event) {
		graphicSel.classed('is-fixed', true);
		var bottom = event.scrollDirection === 'REVERSE';
...
function resizeScrollElements() {
	...
	if (enterExitScene) {
		var proseEl = proseSel.node();
		var duration = proseEl.offsetHeight - height;
		enterExitScene.duration(duration);

		stepScenes.forEach(function (scene) {
...
function resizeBars() {
	...
	var barResize = d3.selectAll('.bars');

	barResize.attr('x', function (d) {
		return scaleX(d.data.year);
	}).attr('y', function (d) {
		return scaleY(d[1]);
...
exports.default = { init: init, resize: resize };
});
___scope___.file("load-data.js", function(exports, require, module, __filename, __dirname){
...
FuseBox.pkg("scrollmagic", {}, function(___scope___){
___scope___.file("scrollmagic/uncompressed/ScrollMagic.js", function(exports, require, module, __filename, __dirname){
...
return ___scope___.entry = "scrollmagic/uncompressed/ScrollMagic.js";
});
